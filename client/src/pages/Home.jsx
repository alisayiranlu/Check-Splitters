  ...
  return (
    <div className="page">
      <div className="topbar">
        <button className="icon-btn" style={{ color: 'rgba(255,255,255,0.8)', background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', padding: 4 }}>
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/>
          </svg>
        </button>
        <span className="topbar-title">Check Splitter</span>
        {participant ? (
          <div className="avatar" style={{ background: participant.avatar_color ?? '#0D9488', width: 36, height: 36, fontSize: '0.875rem' }}>
